                ...
                <table class=" table table-bordered table-striped table-hover datatable">
                    ...
                    <tbody>
                        ...
                        <tr data-entry-id="{{ $slider->id }}">
                            ...
                            <td><img src="/storage/sliders/{{ $slider->picture_mb }}" height="250px" height="auto" /></td>
                            <td>{{ $slider->title ?? ''}}</td>
                ...
                <div class="modal-body" id="english-form">
                    <div class="form-group" >
                        ...
                        <div class="col-md-6">
                            ...
                            <h5 style="color: red">Size: 1920*950px</h5>
                        </div>
                    </div>
                    <div class="form-group" >
                        <label for="avatar" class="col-md-2 control-label">Image Mobile</label>
                        <div class="col-md-6">
                            <input type="file" id="picture_mb" name="picture_mb" required>
                            <h5 style="color: red">Size: 380*950px</h5>
                        </div>
                    </div>
