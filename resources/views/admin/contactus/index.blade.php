            ...
            <div class="card">
                ...
                @endif
                    <div class="card-body" id="english-form">
                        ...
                        <div class="form-group  row{{ $errors->has('phone1') ? 'has-error' : '' }}">
                            <label for="phone1" class="col-md-2 col-form-label ">Second {{ trans('global.contactus.fields.phone') }}</label>
                            <div class="col-md-10">
                                <input type="text" id="phone1" name="phone1" class="form-control" value="{{ old('phone1', isset($contactus) ? $contactus->phone1 : '') }}" placeholder="Ex: +123456789" >
                                @if ($errors->has('phone'))
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $errors->first('phone') }}</strong>
                                </span>
                        ...
                        <div class="form-group  row{{ $errors->has('email') ? 'has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <input type="email" id="email" name="email" class="form-control" value="{{ old('email', isset($contactus) ? $contactus->email : '') }}" placeholder="Ex: example@example.com" >
                                @if ($errors->has('email'))
                                <span class="invalid-feedback" role="alert">
                        ...
                        <div class="form-group  row{{ $errors->has('email1') ? 'has-error' : '' }}">
                            <label for="email1" class="col-md-2 col-form-label ">{{ trans('global.contactus.fields.email') }} 2</label>
                            <div class="col-md-10">
                                <input type="email" id="email1" name="email1" class="form-control" value="{{ old('email1', isset($contactus) ? $contactus->email1 : '') }}" placeholder="Ex: example@example.com" >
                                @if ($errors->has('email'))
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $errors->first('email') }}</strong>
                                </span>
